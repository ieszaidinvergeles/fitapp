...
function voltgym_required_pages(): array
{
    return [
        ...
        'staff-manage-gym-inventory' => 'Gym Equipment Inventory',
        'staff-create-gym-inventory' => 'Create Gym Inventory',
        'staff-edit-gym-inventory'   => 'Edit Gym Inventory',
        'staff-view-gym-inventory'   => 'View Gym Inventory',
        'staff-rooms'            => 'Rooms',
